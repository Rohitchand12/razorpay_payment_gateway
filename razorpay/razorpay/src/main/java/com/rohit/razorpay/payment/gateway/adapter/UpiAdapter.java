...
@Slf4j
public class UpiAdapter implements PaymentGatewayAdapter {
    private final PaymentProcessorRouter paymentProcessorRouter;
    @Override
    public PaymentResult initiate(PaymentRequest request) {
        log.info("Initiating UPI payment with payment id: {}",request.paymentId());
        try{
            ...
            log.warn("UPI payment failed, payment id: {}", request.paymentId());
